...
class Login:
    ...
    def __init__(self):
        ...
        btn_login = tk.Button(self.window, text=' 登  录 ',
                              command=lambda: self.login(entry_usr_name.get(), var_usr_pwd.get()), width=42, height=2,
                              bg='#90CBFB')
    ...
    def login(self, user, passwd):
        ...
        self.tips_label = tk.Label(self.window, text=r, fg=c)
        self.tips_label.place(x=52, y=305)
